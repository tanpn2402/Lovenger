...
import com.tanpn.messenger.pagetransformer.DepthPageTransformer;
import com.tanpn.messenger.pagetransformer.DrawFromBackTransformer;
import com.tanpn.messenger.pagetransformer.FadePageTransformer;
import com.tanpn.messenger.pagetransformer.FlipHorizontalTransformer;
import com.tanpn.messenger.pagetransformer.RotateDownTransformer;
...
public class EventView extends AppCompatActivity implements View.OnClickListener, ChildEventListener, OnSettingChanged{
    ...
    private void init(){
        ...
        ibtEventDetail = (ImageView) findViewById(R.id.ibtDetail);
        ibtEventDetail.setOnClickListener(this);
        ibtEventShare = (ImageView) findViewById(R.id.ibtShare);
    ...
    public void onChanged(int resId) {
        if(resId == R.string.pref_key_photo_view_effect){
